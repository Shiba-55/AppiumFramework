    ...
    public void createAPIFeatureFile(String featureName, String description, String scenario, String testCaseName, String testCaseSheet, String testingType, JSONObject jsonTestData) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                lines.add("\t\t" + createAPIStep(steps, baseURI, endPoint, method, params, auth, headers, body, script, field, counterAPI));
            ...
            tempJson.put("APICounts", counterAPI - 1);
...
//                }
    ...
    public String createAPIStep(String steps, String baseURI, String endPoint, String method, String params, String auth, String headers, String body, String script, String field, int counterAPI) {
